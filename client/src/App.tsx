    ...
    return (
      <div className="detail-pane">
        <div className="detail-cover">
          <button className="cover-button" onClick={onBack}><ArrowLeft size={16} /></button>
          <div><h1>No group selected</h1><p>Select a group from My Groups or create a new group wallet.</p></div>
        </div>
      </div>
    );
  }
